...
(function run() {
    ...
    console.log(`Military airport sorted by max distance: ${Airport.printJson(militaryAirport.sortByMaxDistance())}`);
    console.log(`Passenger airport sorted by max speed: ${Airport.printJson(passengerAirport.sortByMaxSpeed())}`);
    console.log(`Plane with max passenger capacity: ${Airport.printJson(passengerAirport.getPassengerPlaneWithMaxPassengersCapacity())}`);
})();